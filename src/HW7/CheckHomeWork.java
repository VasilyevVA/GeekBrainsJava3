...
public class CheckHomeWork {
    ...
    private void testSum() throws Exception {
        ...
        while (it.hasNext()) {
            ...
            Class ch = URLClassLoader.newInstance(new URL[]{new File("C:/0123").toURL()}).loadClass(name);
            ...
            String res8 = (String) m8.invoke(calc,2021);
            System.out.println(res8);

            if (res == 4 && res3 == 2 && res4 && res5 == "positive" && res6 && res7.equalsIgnoreCase("Hello, Ivan") && res8 == "Этот год високосный") {
